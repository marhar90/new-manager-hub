---
title: "Fellow vs 15Five: Best 1:1 Meeting Tool for New Managers"
description: "An honest comparison of Fellow and 15Five for running 1:1 meetings as a new manager. Which one actually helps, and which one gets in the way?"
date: "2026-03-19"
category: tools
tags: [tools, comparison, 1-on-1]
---
...
**Pricing is reasonable.** The free tier covers the basics. The pro plan runs about [$9/user/month](https://example.com/fellow-pricing) and includes everything a new manager needs.

[Try Fellow free](https://example.com/fellow-trial)
...
**Pricing starts around [$4/user/month](https://example.com/15five-pricing)** for the Engage tier, but the full Perform tier with 1:1s and reviews runs about [$14/user/month](https://example.com/15five-full-pricing).
...
**If you're a new manager picking your own tool:** go with [Fellow](https://example.com/fellow-signup). It does the one thing you need right now and does it well. You can always add more tools later as your management practice matures.
...
**If you're not ready for either:** a shared Google Doc works fine. Seriously. The tool matters less than the habit. If you want tips on what to actually discuss, check out [how to run your first 1:1 meeting](/advice/first-1on1-meeting) -- the framework works regardless of what software you use.

And if you're still in your first week figuring all this out, start with [the first-week survival guide](/advice/first-week-as-manager) before worrying about tooling.
